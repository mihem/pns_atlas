...
if (!file.exists("perineurial_figure.qs")) {
    download.file(
        "https://zenodo.org/records/14551660/files/perineurial_figure.qs?download=1",
...
if (!file.exists("cxcl14_data.qs")) {
    download.file(
        "https://zenodo.org/records/14551660/files/cxcl14_data.qs?download=1",
        "cxcl14_data.qs"
    )
}
...
if (!file.exists("data_peri_diagnosis.qs")) {
    download.file(
        "https://zenodo.org/records/14551660/files/data_peri_diagnosis.qs?download=1",
...
if (!file.exists("data_peri_var.qs")) {
    download.file(
        "https://zenodo.org/records/14551660/files/data_peri_var.qs?download=1",
        "data_peri_var.qs"
    )
}
...
if (!file.exists("dotplot_data_cxcr4.qs")) {
    download.file(
        "https://zenodo.org/records/14551660/files/dotplot_data_cxcr4.qs?download=1",
...
if (!file.exists("liana_results_aggregate.qs")) {
    download.file(
        "https://zenodo.org/records/14551660/files/liana_results_aggregate.qs?download=1",
...
if (!file.exists("xenium_trem2.qs")) {
    download.file(
        "https://zenodo.org/records/14551660/files/xenium_trem2.qs?download=1",
        "xenium_trem2.qs"
    )
}
