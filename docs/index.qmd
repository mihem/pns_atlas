...
if (!file.exists("axon_count.qs")) {
    download.file(
        "https://zenodo.org/records/14226219/files/axon_count.qs?download=1",
        "axon_count.qs"
    )
}
...
if(!file.exists("abundance_axon.qs")) {
    download.file(
        "https://zenodo.org/records/14226219/files/abundance_axon.qs?download=1",
        "abundance_axon.qs"
    )
}
...
if(!file.exists("xenium_sc_t_nk.qs")) {
    download.file(
        "https://zenodo.org/records/14226219/files/xenium_sc_t_nk.qs?download=1",
        "xenium_sc_t_nk.qs"
    )
}
